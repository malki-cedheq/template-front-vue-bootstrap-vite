...
<template>
	<div id="app" class="container">
		<div
			...
			tabindex="-1"
			role="dialog"
			aria-labelledby="excluir_modalLabel"
			aria-hidden="true"
		>
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
					<div class="modal-header card-header">
						<h5 class="modal-title" id="excluir_modalLabel">
		...
		<div v-else>
			...
			<router-link
				to="/user/create"
				class="btn btn-outline-primary float-start my-3"
				><font-awesome-icon icon="user-plus" /> Add User</router-link
			>
